...
data "aws_iam_policy_document" "codepipeline" {
  ...
  statement {
    ...
    resources = compact([
      module.cleanup_app_deployment_lambda.arn,
      module.prepare_ami_deployment_lambda.arn,
      module.prepare_app_deployment_lambda.arn,
    ])
  }
  ...
  statement {
    ...
    resources = [
      "arn:aws:s3:::${var.source_location.bucket}",
      "arn:aws:s3:::${var.source_location.bucket}/*",
    ]
  }
}
